...
public class Blackjack {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("..Ready? Hit enter to begin!");
    ...
    public static String hitOrStay(){
        ...
        while (!(userDecision.equalsIgnoreCase("hit") || userDecision.equalsIgnoreCase("stay"))) {
